...
async function start() {
  ...
  dailyActivities.forEach(dailyActivity => {
    ...
    if (previousRecordWeekNumber !== dailyActivity.weekNumber) {
      console.log(previousRecordWeekNumber, dailyActivity.weekNumber)
...
async function writeMDFile(arrMd) {
  ...
  //   //   blockquote: [
  //   //     // {h2: 'Ocak'},
  //   //     // {blockquote: ['01.01.2021', {ul: [`asd`, 'fio: 4 -> 8']}]},
  //   //     // {blockquote: ['02.01.2021', {ul: ['jsa: 15 -> 28', 'rn: 243 -> 247']}]},
  //   //     ...monthsMD,
  //   //     '&nbsp;',
  //   //   ],
  //   // },
  ...
  try {
    ...
    await fs.writeFile('../2021.md', replacedMd, (e) => console.log(e))
